...
class NeuralNetwork():
    def __init__(self):
        ...
        # We assigned random weights to a 3 x 1 matrix, with values in the range -1 to 1 and mean 0
    ...
    # It indiciates how confident we are about the existing weight
    def __sigmoid_derivative(self, x):
        return x * (1 - x)

    # We train the neural network through a process of trial and error
    # It then self-adjusts the synaptic weights each time
